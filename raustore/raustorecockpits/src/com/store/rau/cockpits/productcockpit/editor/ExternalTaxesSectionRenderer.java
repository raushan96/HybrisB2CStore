 ...
 */
package com.store.rau.cockpits.productcockpit.editor;
...
public class ExternalTaxesSectionRenderer implements SectionRenderer
{
	...
	protected void constructHbox(final SectionPanel panel, final Div mainCnt,
		...
		if (secConfig != null)
		{
			...
			final Label rowLabel = new Label(Labels.getLabel("raustorecockpits.product.externalTaxes"));
			rowLabel.setTooltiptext(Labels.getLabel("raustorecockpits.product.externalTaxes"));
