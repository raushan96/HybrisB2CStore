 ...
 */
package com.store.rau.core.suggestion;
...
import com.store.rau.core.suggestion.impl.DefaultSimpleSuggestionService;
...
public class DefaultSimpleSuggestionServiceIntegrationTest extends ServicelayerTransactionalTest
{
	...
	{
		importCsv("/raustorecore/test/testSimpleSuggestionService.csv", "utf-8");
	}
