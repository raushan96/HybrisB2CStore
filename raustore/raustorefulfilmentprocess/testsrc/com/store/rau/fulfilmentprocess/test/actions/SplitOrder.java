 ...
 */
package com.store.rau.fulfilmentprocess.test.actions;
...
public class SplitOrder extends TestActionTemp
{
	...
	public String execute(final BusinessProcessModel process) throws Exception //NOPMD
	{
		...
		warehouseCounter.setName(RaustoreFulfilmentProcessConstants.CONSIGNMENT_COUNTER);
		...
		params.setName(RaustoreFulfilmentProcessConstants.PARENT_PROCESS);
