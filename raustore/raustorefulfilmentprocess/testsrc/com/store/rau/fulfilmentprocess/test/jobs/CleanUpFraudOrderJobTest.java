 ...
 */
package com.store.rau.fulfilmentprocess.test.jobs;
...
import com.store.rau.fulfilmentprocess.jobs.CleanUpFraudOrderJob;
...
public class CleanUpFraudOrderJobTest extends ServicelayerTransactionalTest
{
	...
	private static final String PROCESS_DEFINITION_NAME = RaustoreFulfilmentProcessConstants.ORDER_PROCESS_NAME;
