...
public class AccountSupportTicketsPageController extends AbstractSearchPageController
{
	...
	public String addSupportTicket(final Model model) throws CMSItemNotFoundException
	{
		...
		model.addAttribute(WebConstants.BREADCRUMBS_KEY, getBreadcrumbs(CustomerticketingaddonConstants.TEXT_SUPPORT_TICKETING_ADD));
		model.addAttribute(ThirdPartyConstants.SeoRobots.META_ROBOTS, ThirdPartyConstants.SeoRobots.NOINDEX_NOFOLLOW);
		model.addAttribute(CustomerticketingaddonConstants.SUPPORT_TICKET_FORM, new SupportTicketForm());
		model.addAttribute(CustomerticketingaddonConstants.MAX_UPLOAD_SIZE, maxUploadSizeValue);
			...
			final BindingResult bindingResult)
	{
		...
		{
			List<Map<String, String>> list = buildErrorMessagesMap(bindingResult);
			...
			final RedirectAttributes redirectModel) throws CMSItemNotFoundException
	{
		...
		if (Boolean.TRUE.equals(ticketUpdated))
		{
			GlobalMessages.addConfMessage(model, CustomerticketingaddonConstants.TEXT_SUPPORT_TICKETING_ADDED);
		}
	 ...
	 * @param key	the render key
	 * @param localisedKey	the localised message key
	 * @return Map of error code and message
	 */
	protected Map<String, String> buildMessageMap(String key, String localisedKey)
	{
		Map<String, String> map = Maps.newHashMap();
