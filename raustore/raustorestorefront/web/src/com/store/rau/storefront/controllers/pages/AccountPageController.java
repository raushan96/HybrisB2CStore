...
import com.store.rau.storefront.forms.validation.ProfileValidator;
...
public class AccountPageController extends AbstractSearchPageController
{
	...
	@Resource(name = "raustoreProfileValidator")
	...
	public String editProfile(final Model model) throws CMSItemNotFoundException
	{
		...
		updateProfileForm.setMobileNumber(customerData.getMobileNumber());
