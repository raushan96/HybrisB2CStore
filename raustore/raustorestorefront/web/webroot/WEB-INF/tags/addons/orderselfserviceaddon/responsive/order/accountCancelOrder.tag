            ...
            <c:if test="${entry.entryNumber != -1 && entry.cancellableQty > 0 }">
                ...
                <li class="item__list--item">
                    ...
                    <div class="item__quantity visible-xs visible-sm">
                        <div class="item__quantity-wrapper">
                            <div class="js-qty-form${loop.index}" action="">
                                <label class="visible-xs visible-sm item__quantity__input-label" path="quantity" for="quantity${entry.entryNumber}"> <spring:theme code="text.account.cancel.qty"/></label>
                                <c:set var="key" value="${entry.entryNumber}"/>
                                <form:input class="form-control js-update-entry-quantity-input" type="text" size="1"
                                            path="cancelEntryQuantity[${key}]"/>
                            </div>
                    ...
                    <c:if test="${nentry.cancellableQty > 0}">
                        <li class="item__list--item">
                            ...
                            <div class="item__quantity visible-xs visible-sm">
                                <div class="item__quantity-wrapper">
                                    <div class="js-qty-form${nloop.index}" action="">
                                        <label class="visible-xs visible-sm item__quantity__input-label" path="quantity" for="quantity${nentry.entryNumber}"> <spring:theme code="text.account.cancel.qty"/></label>
                                        <c:set var="key" value="${nentry.entryNumber}"/>
                                        <form:input class="form-control js-update-entry-quantity-input" type="text" size="1"
                                                    path="cancelEntryQuantity[${key}]"/>
                                    </div>
            ...
            <div class="cancel-actions">
                <div class="row">
                    <div class="col-sm-6 col-sm-offset-6">
                        ...
                        <button type="submit" class="btn btn-primary btn-block" id="cancelOrderButtonConfirmation" disabled="disabled">
