 ...
 */
package com.store.rau.test.setup;
...
import com.store.rau.test.constants.RaustoreTestConstants;
import com.store.rau.test.orders.AcceleratorTestOrderData;
 ...
 */
@SystemSetup(extension = RaustoreTestConstants.EXTENSIONNAME)
public class TestDataSystemSetup extends AbstractSystemSetup
{
	...
	public void createProjectData(final SystemSetupContext context)
	{
		if (getBooleanSystemSetupParameter(context, CREATE_TEST_DATA))
		{
			...
			importImpexFile(context, "/raustoretest/import/qa-test-users.impex");

			LOG.info("Creating Reviews...");
			importImpexFile(context, "/raustoretest/import/reviews.impex");
			...
			importImpexFile(context, "/raustoretest/import/cstickets.impex");
		}
	}
}
